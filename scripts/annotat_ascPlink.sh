...
'write.table(dataMerge[,c(2:19,1,22:29,31:34)],paste(args[2],args[5],sep="."), sep="\t", quote=F, row.names=F, col.names=T);' $VCF_info $assocTable $varEffect $TransInfo $suffix
